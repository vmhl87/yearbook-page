Finetuned ray-tracer adapted from [https://github.com/vmhl87/path-tracing](https://github.com/vmhl87/path-tracing), used to render my personal page in my school's yearbook.
